...
if __name__ == "__main__":
    ...
    parser.add_argument('--mmax', type=float, default=1000000000, help='maximum number of MACS allowed')
    ...
    #log.info('Best epsilon: {}'.format(best_epsilon))s
    ...
    with open(save_path, 'w') as handle:
            json.dump(results, handle, cls=NumpyEncoder)
